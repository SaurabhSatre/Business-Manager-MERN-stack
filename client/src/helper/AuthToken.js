...
class AuthToken {
  ...
  static isValidToken() {
    ...
    return (
      ...
      user.authorityStatus !== undefined
    );
  }
  ...
  // Get userStatus from token
  static getUserStatus() {
    const decoded = AuthToken.decodeToken();
    return decoded?.userDetails?.userStatus || null;
  }
  ...
  // Get authorityStatus from token
  static getAuthorityStatus() {
    const decoded = AuthToken.decodeToken();
    return decoded?.userDetails?.authorityStatus || null;
  }
